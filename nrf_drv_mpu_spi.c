...
#define MPU_SPI_SCL_PIN     5  // MPU SCLK. 'SCL' on MPU breakout board silk screen
#define MPU_SPI_CS_PIN      6 // MPU nCS. 'NCS' on MPU breakout board silk screen
#else // If PCA10028
#define MPU_SPI_MISO_PIN    3 // MPU SDO. 'AD0' on MPU breakout board silk screen
...
{
    nrf_drv_spi_config_t spi_mpu_config = NRF_DRV_SPI_DEFAULT_CONFIG;
    spi_mpu_config.sck_pin      = MPU_SPI_SCL_PIN;
    spi_mpu_config.mosi_pin     = MPU_SPI_MOSI_PIN;
    spi_mpu_config.miso_pin     = MPU_SPI_MISO_PIN;
    spi_mpu_config.ss_pin       = MPU_SPI_CS_PIN;
    spi_mpu_config.irq_priority = APP_IRQ_PRIORITY_HIGH;
    spi_mpu_config.orc          = 0xFF;
    spi_mpu_config.frequency    = NRF_DRV_SPI_FREQ_1M;
    spi_mpu_config.mode         = NRF_DRV_SPI_MODE_0;
    spi_mpu_config.bit_order    = NRF_DRV_SPI_BIT_ORDER_MSB_FIRST;
